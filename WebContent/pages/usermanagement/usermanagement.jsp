...
<link type="text/css" rel="stylesheet" href="usemanagement.css">
...
<%@include file="../../mainjsp/main.jsp" %>
		...
		<div class="user_manager">
			<div class="table_header">
				...
				<p class="left" id="saveuser">save user</p>
			...
			<div class="table_style">
				<table>
					...
					<tr>
						...
						<a href="../../UserManagement?account=${user.getUserAccount()}">delete user</a>
						</td>
					</tr>
					</c:forEach>
					</c:if>
